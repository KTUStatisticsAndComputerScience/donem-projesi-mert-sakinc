...
<template>
  <div class="row">
    <div class="col-1"></div>
    <div class="col-10 kargo__ekle">
      <h1>Kargo Ekle</h1>
      <hr class="style" />
      <div class="row liste__row">
        <div class="col-3">
        ...
        <div class="col-9">
          <select
            name="fgonderici"
            v-model="eklenecek_kargo.kargo_gonderici_id"
          >
            <option selected="selected" value="">
              Değiştirmek için seçim yapın
            </option>
            <option v-for="kisi in personStore.persons" :value="kisi.kisi_id">
              {{ kisi.kisi_ad + " " + kisi.kisi_soyad }}
            </option>
          </select>
        </div>
      </div>
      ...
      <div class="row liste__row">
        ...
        <div class="col-9">
          <input
            ...
            v-model="eklenecek_kargo.kargo_en"
          />
        </div>
      </div>
      <div class="row liste__row">
        ...
        <div class="col-9">
          <input
            ...
            v-model="eklenecek_kargo.kargo_yukseklik"
          />
        </div>
      </div>
      <div class="row liste__row">
        ...
        <div class="col-9">
          <input
            ...
            v-model="eklenecek_kargo.kargo_boy"
          />
        </div>
      </div>
      <div class="row liste__row">
        ...
        <div class="col-9">
          <input
            ...
            v-model="eklenecek_kargo.kargo_agirlik"
          />
        </div>
      </div>

      <div>
        <button class="btn" @click="kaydet">
          <font-awesome-icon icon="fa-solid fa-paper-plane" /> Gönder
        </button>
      </div>
    </div>
